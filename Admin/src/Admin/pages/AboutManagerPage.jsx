      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl font-bold text-white flex items-center gap-2">
            <UserCheck className="w-5 h-5 text-zinc-300" /> About & Bio Manager
          </h1>
        ...
        <div className="pt-6 border-t border-zinc-800/80 space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-1 text-xs font-bold text-zinc-200 hover:text-white px-3 py-1.5 bg-zinc-900 hover:bg-zinc-800 rounded-xl border border-zinc-700 cursor-pointer"
            >
          ...
          <div className="space-y-3">
            {(formData.full_bio_paragraphs || []).map((para, index) => (
              <div key={index} className="p-4 rounded-xl bg-zinc-900 border border-zinc-800 space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-zinc-400">Paragraph {index + 1}</span>
                  <button
                    type="button"
                ...
                <textarea
                  ...
                  className="w-full text-xs p-3 rounded-lg bg-zinc-950 border border-zinc-800 text-zinc-100 outline-none focus:border-zinc-500 placeholder:text-zinc-600"
