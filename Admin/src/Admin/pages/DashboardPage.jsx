...
export const DashboardPage = () => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-200">
      {/* Welcome Banner */}
      <div className="relative overflow-hidden rounded-3xl bg-zinc-950 border border-zinc-800/80 p-6 sm:p-8 shadow-xl">
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-900 border border-zinc-700 text-xs font-semibold text-zinc-300">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button
              ...
              disabled={syncing}
              className="flex items-center gap-2 px-4 py-2.5 bg-zinc-900 hover:bg-zinc-800 text-zinc-200 text-xs font-bold rounded-xl border border-zinc-700 transition-all cursor-pointer disabled:opacity-50"
            >
            ...
            <a
              ...
              className="flex items-center gap-2 px-4 py-2.5 bg-zinc-100 hover:bg-white text-black text-xs font-black rounded-xl transition-all shadow-md active:scale-98"
            >
        ...
        {statCards.map((card) => {
          ...
          return (
            <div
              ...
              className="group bg-zinc-950 border border-zinc-800/80 hover:border-zinc-700 p-6 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-200 cursor-pointer flex flex-col justify-between space-y-4"
            >
              <div className="flex items-start justify-between">
                <div className="w-12 h-12 rounded-xl bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-300 group-hover:text-white transition-colors">
                  <Icon className="w-6 h-6" />
                </div>
                <div className="p-1 text-zinc-600 group-hover:text-zinc-300 transition-colors">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Quick Actions */}
        <div className="bg-zinc-950 border border-zinc-800/80 rounded-2xl p-6 shadow-md space-y-4">
          <h2 className="text-sm font-bold text-white flex items-center gap-2">
            <Sparkles className="w-4 h-4 text-amber-400" /> Frequent CMS Tasks
          </h2>
          ...
          <div className="space-y-2">
            {[
              ...
              <button
                ...
                className="w-full text-left p-3 rounded-xl bg-zinc-900/60 hover:bg-zinc-900 border border-zinc-800/80 hover:border-zinc-700 transition-all cursor-pointer group"
              >
        ...
        {/* Audit Log Stream */}
        <div className="lg:col-span-2 bg-zinc-950 border border-zinc-800/80 rounded-2xl p-6 shadow-md space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-sm font-bold text-white flex items-center gap-2">
              <Clock className="w-4 h-4 text-zinc-400" /> Recent Content Audit Trail
            </h2>
            <button
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-semibold text-zinc-200">
                      ...
                      {log.entity_id && <span className="text-zinc-500 text-[10px] font-normal ml-1">({log.entity_id})</span>}
                    </span>
                  </div>
