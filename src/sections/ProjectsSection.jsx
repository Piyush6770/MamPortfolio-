...
export const ProjectsSection = () => (
  <section id="projects" className="py-16 bg-white dark:bg-[#0f172a] border-b border-[#ebebeb] dark:border-[#2e2e30]">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-left">
      <SectionHeader badge="GRANTS & SPONSORSHIPS" title="Research Projects & Funding"
            ...
            <div>
              <div className="flex items-center justify-between gap-2 mb-3">
                ...
                <span className="flex items-center gap-1 text-xs text-slate-500 dark:text-slate-400 font-semibold">
                  <CheckCircle className="w-3.5 h-3.5 text-emerald-500" />{project.status}
                </span>
              </div>
              <h3 className="text-sm font-semibold text-slate-800 dark:text-slate-100 leading-snug mb-2" style={{fontFamily: "'Merriweather', serif"}}>{project.title}</h3>
